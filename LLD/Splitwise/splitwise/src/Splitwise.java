...
import splitwise.src.group.Group;
import splitwise.src.group.GroupController;
import splitwise.src.user.User;
import splitwise.src.user.UserController;
...
public class Splitwise {
    ...
    public void demo() {
        ...
        group.createExpense("Exp1002", "Lunch", 500, splits2, ExpenseSplitType.UN_EQUAL, userController.getUser("U2001"));
