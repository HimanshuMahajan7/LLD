...
public class DBConnectionPoolManager {
    ...
    private static DBConnectionPoolManager connectionPoolManagerInstance = null;
    ...
    public static DBConnectionPoolManager getInstance() {
        if (connectionPoolManagerInstance == null) {
            synchronized (DBConnectionPoolManager.class) {
                if (connectionPoolManagerInstance == null) {
                    connectionPoolManagerInstance = new DBConnectionPoolManager();
                }
            }
        }
